...
// import { LogOut, Key, Sun, Moon, Trash2, Edit2, Settings, X, Users, Calendar, Menu } from 'lucide-react';
...
//     <button
//         onClick={onClick}
//         className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition font-semibold ${active
...
// const AppointmentsPage = ({ appointments, stats, appointmentPercentage, handleDeleteAppointment, darkMode, t, selectedDate, setSelectedDate, availableDates, selectedDateAppointments }) => (
...
//             <h3 className="text-[#0B8FAC] font-bold text-lg mb-4">📅 {t.selectDate}</h3>
//             <div className="flex gap-2 overflow-x-auto pb-2">
//                 {availableDates.length === 0 ? (
//                     <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>{t.noAppointmentsToday}</p>
//                 ) : (
...
//                 <h3 className="font-bold text-xl">📆 {t.appointmentsFor} {new Date(selectedDate).toLocaleDateString()}</h3>
//             </div>
